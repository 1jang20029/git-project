...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkAndInitMap() {
        if (typeof naver !== 'undefined' && naver.maps) {
            ...
            mapInitAttempts++;
            console.log(`네이버 지도 API 로드 대기 중... (${mapInitAttempts}/${maxAttempts})`);
